...
type envAccessor struct {
	...
	GroupID            string `envconfig:"CONFLUENT_GROUP_ID" required:"false" default:"kafkatarget"`
	SecurityMechanisms string `envconfig:"CONFLUENT_SECURITY_MECANISMS" required:"false" default:"SCRAM-SHA-256"`
	...
	SSLClientCert string `envconfig:"SSL_CLIENT_CERT" required:"true"`
	SSLClientKey  string `envconfig:"SSL_CLIENT_KEY" required:"true"`
...
func NewAdapter(ctx context.Context, envAcc pkgadapter.EnvConfigAccessor, ceClient cloudevents.Client) pkgadapter.Adapter {
	...
	kafkaClient, err := NewKafkaClient(&kafka.ConfigMap{
		...
		"sasl.username":            "cxnpl-poc-sa",
		"sasl.password":            "aYupifBYaT;CP_loz-6dt-",
